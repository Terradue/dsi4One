...
# The DSI Information Manager Driver
class DSIInformationManagerDriver < OpenNebulaDriver
    ...
    def initialize()
        ...
        @info="HYPERVISOR=dsi,TOTALMEMORY=#{totalmemory},"<<
...
# The DSI Information Driver main program
im = DSIInformationManagerDriver.new
im.start_driver
